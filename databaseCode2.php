...
DEFINE ('DB_USER', 'chuacon');  //  you should put your username here
DEFINE ('DB_PASSWORD', 'xLR8T1ON'); //  you should put your password (studentID) here
DEFINE ('DB_HOST', 'ccc.wpi.edu');
DEFINE ('DB_NAME', 'TaxiGPSdb'); //  you should put the database name here.
